...
const BT_SPAWNS_BLUE = [
    { x: 14, z: 12, yaw: -Math.PI + 0.75 },
    { x: 12, z: 5, yaw: -Math.PI + 0.6 },
    { x: 15, z: -1, yaw: -Math.PI + 0.35 },
    { x: 10, z: 10, yaw: -Math.PI + 0.5 },
    { x: 16, z: -6, yaw: -Math.PI + 0.9 },
    { x: 8, z: 15, yaw: -Math.PI + 0.3 }
];
